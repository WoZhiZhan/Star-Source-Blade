...
public class SchrodingerSlashArts extends SlashArts {
    public SchrodingerSlashArts(Function<LivingEntity, ResourceLocation> state) {
        super(state);
    }
            ...
            if (user instanceof Player player) {
                ...
                for (int i = 0; i < count; i++) {
                    if (!world.isClientSide()) {
                        StormSwordSpawner.executeIceSwordWave(player, world, 2, 20);
                    }
                }
            }
        });
