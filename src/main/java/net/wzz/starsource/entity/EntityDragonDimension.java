...
public class EntityDragonDimension extends Entity implements IThrowableEntity {
    ...
    public EntityDragonDimension(World par1World) {
        super(par1World);
    ...
    public EntityDragonDimension(World par1World, EntityLivingBase entityLiving, float AttackLevel, boolean multiHit) {
        this(par1World, entityLiving, AttackLevel);
        this.setIsSingleHit(multiHit);
    }

    public EntityDragonDimension(World par1World, EntityLivingBase entityLiving, float AttackLevel) {
        this(par1World);
    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            for (Entity e : world.getEntitiesWithinAABBExcludingEntity(null,
                    getEntityBoundingBox().grow(15))) {
                if (e != null && e != this && !(e instanceof EntityPlayer) && !(e instanceof EntityDrive) && !(e instanceof EntitySummonedSword)
                 && !(e instanceof EntityItem)) {
                    double attractStrength = 1;
                    ...
                    e.motionZ += forceZ;
                    e.setFire(10);
                    e.attackEntityFrom(DamageSource.OUT_OF_WORLD,100);
    ...
    static {
        LIFETIME = EntityDataManager.createKey(EntityDragonDimension.class, DataSerializers.VARINT);
        SINGLE_HIT = EntityDataManager.createKey(EntityDragonDimension.class, DataSerializers.BOOLEAN);
        IS_SLASH_DIMENSION = EntityDataManager.createKey(EntityDragonDimension.class, DataSerializers.BOOLEAN);
        THROWER_ENTITY_ID = EntityDataManager.createKey(EntityDragonDimension.class, DataSerializers.VARINT);
        INTERVAL = EntityDataManager.createKey(EntityDragonDimension.class, DataSerializers.VARINT);
        COLOR = EntityDataManager.createKey(EntityDragonDimension.class, DataSerializers.VARINT);
    }
}
