...
public class RenderDragonDimension extends Render {
    ...
    public RenderDragonDimension(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    public void renderModel(Entity entity, double x, double y, double z, float yaw, float partialRenderTick) {
        ...
        List<Integer> colors = Collections.singletonList(0xFF0000);
