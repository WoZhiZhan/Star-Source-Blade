...
public class ItemAstralShadowSlashBlade extends ItemStarSourceSlashBlade {

    public ItemAstralShadowSlashBlade() {
        super("astral_shadow");
        ItemStack itemStack = new ItemStack(this);
        NBTTagCompound tag = new NBTTagCompound();
        itemStack.setTagCompound(tag);
        itemStack.addEnchantment(Enchantments.INFINITY, 5);
        CurrentItemName.set(tag, "astral_shadow");
        ...
        SlashBlade.registerCustomItemStack("astral_shadow", itemStack);
    ...
    private static ResourceLocationRaw texture = new ResourceLocationRaw("flammpfeil.slashblade", "model/named/starsource/astral_shadow.png");
    ...
    public SpecialAttackBase getSpecialAttack(ItemStack stack) {
        return AstralShadowSpecialAttacks.theSa;
    }
}
